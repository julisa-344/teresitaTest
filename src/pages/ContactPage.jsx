        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-primary-600 mb-2">24h</div>
              <div className="text-neutral-600">Tiempo de respuesta</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-secondary-600 mb-2">98%</div>
              <div className="text-neutral-600">Satisfacción del cliente</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-primary-600 mb-2">10</div>
              <div className="text-neutral-600">Canales de contacto</div>
            </div>
            <div className="text-center">
              <div className="text-4xl lg:text-5xl font-bold text-secondary-600 mb-2">24/7</div>
              <div className="text-neutral-600">WhatsApp disponible</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral-800 mb-2">WhatsApp Business</h3>
            ...
            {/* Teléfono */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              <div className="text-6xl mb-4">📞</div>
              <h3 className="text-xl font-bold text-neutral-800 mb-2">Línea Directa</h3>
              <p className="text-neutral-600 mb-4">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              <div className="text-6xl mb-4">📱</div>
              <h3 className="text-xl font-bold text-neutral-800 mb-2">Redes Sociales</h3>
              <p className="text-neutral-600 mb-4">
            ...
            {/* Visítanos */}
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              <div className="text-6xl mb-4">📍</div>
              <h3 className="text-xl font-bold text-neutral-800 mb-2">Visítanos</h3>
              <p className="text-neutral-600 mb-4">
            ...
            {/* Centro de Ayuda */}
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-8 text-center hover:shadow-xl transition-all duration-300">
              <div className="text-6xl mb-4">❓</div>
              <h3 className="text-xl font-bold text-neutral-800 mb-2">Centro de Ayuda</h3>
              <p className="text-neutral-600 mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-primary-600 hover:bg-gray-100 px-8 py-4 rounded-xl font-bold transition-all duration-300 transform hover:scale-105">
                WhatsApp Inmediato
              </button>
