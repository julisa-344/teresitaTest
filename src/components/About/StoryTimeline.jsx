      ...
      <div className="lg:w-1/2">
        <div className={`bg-gradient-to-br ${item.gradient} rounded-3xl p-8 lg:p-12 h-80 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300`}>
          <div className="text-center">
            <div className="text-6xl lg:text-7xl mb-4 animate-pulse-soft">
              {item.icon}
            </div>
...
const StoryTimeline = () => {
  return (
    <section className="py-20 bg-gradient-canvas-warm">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-6xl font-display font-bold text-gray-800 mb-6 leading-tight">
        ...
        <div className="text-center mt-20">
          <div className="inline-block bg-primary-700 rounded-full p-6">
            <CursorArrowRaysIcon className="w-12 h-12 text-primary-100 mx-auto" />
          </div>
